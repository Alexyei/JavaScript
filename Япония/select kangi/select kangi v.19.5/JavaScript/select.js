let moduleSelect = (function () {
    ...
    let mobileCountLabels = document.querySelector(".mobile-kanji-count-label");
    ...
    trainBtn.addEventListener("click", (event) => {
        ...
        mobileCountLabels.style.display="flex";
    ...
    function onBack(event){
        ...
        mobileCountLabels.style.display="none";
